...
NETWORK_FILE = PROJECT_DIR / "results" / "networks" / "base_DK_2016.nc"
OUTPUT_DIR = PROJECT_DIR / "results" / "task1_analysis"

GENERATOR_CAPACITY_FILE = (
    PROJECT_DIR
    / "results"
    / "storage_analysis"
    / "generator_capacity_by_year.csv"
)
...
def plot_installed_capacity_by_generator(df: pd.DataFrame, output_path: str | None = None,
...
def main() -> None:
    ...
    if generator_capacity_path.exists():
        ...
        if "generator" in capacity_by_year.columns:
            ...
            print(
                "Warning: 'generator' column missing in generator_capacity_by_year data; skipping generator line plot.")
    else:
